...
class ReflectionActivity : Activity
{
    ...
    public override void Start()
    {
        ...
        Thread.Sleep(DurationInSeconds * 1000); // Wait for the specified duration in milliseconds
...
class ListingActivity : Activity
{
    ...
    public override void Start()
    {
        ...
        // Implement the listing part (user input) here
        ...
        if (int.TryParse(Console.ReadLine(), out int choice))
        {
            switch (choice)
            {
                case 1:
                    ...
                    break;
                case 2:
                    RunActivity(new ReflectionActivity(120)); // Duration in seconds
                    break;
                case 3:
                    RunActivity(new ListingActivity(90)); // Duration in seconds
                    break;
